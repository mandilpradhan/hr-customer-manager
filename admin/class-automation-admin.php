...
if (!class_exists('HR_CM_Automations_Admin')) {
    ...
    class HR_CM_Automations_Admin {
        ...
        private function get_operator_config() {
            return [
                'number' => [
                    ['value' => '=',  'label' => (string) __('Equals', 'hr-customer-manager')],
                    ['value' => '!=', 'label' => (string) __('Does not equal', 'hr-customer-manager')],
                    ['value' => '<',  'label' => (string) __('Less than', 'hr-customer-manager')],
                    ['value' => '<=', 'label' => (string) __('Less than or equal to', 'hr-customer-manager')],
                    ['value' => '>',  'label' => (string) __('Greater than', 'hr-customer-manager')],
                    ['value' => '>=', 'label' => (string) __('Greater than or equal to', 'hr-customer-manager')],
                    ['value' => 'between', 'label' => (string) __('Between', 'hr-customer-manager')],
                ],
                'enum'   => [
                    ['value' => 'is',     'label' => (string) __('Is', 'hr-customer-manager')],
                    ['value' => 'is not', 'label' => (string) __('Is not', 'hr-customer-manager')],
                    ['value' => 'in',     'label' => (string) __('Is one of', 'hr-customer-manager')],
                    ['value' => 'not in', 'label' => (string) __('Is not one of', 'hr-customer-manager')],
                ],
                'string' => [
                    ['value' => 'contains',      'label' => (string) __('Contains', 'hr-customer-manager')],
                    ['value' => 'not contains',  'label' => (string) __('Does not contain', 'hr-customer-manager')],
                    ['value' => 'is',            'label' => (string) __('Is', 'hr-customer-manager')],
                    ['value' => 'is not',        'label' => (string) __('Is not', 'hr-customer-manager')],
                    ['value' => 'is empty',      'label' => (string) __('Is empty', 'hr-customer-manager')],
